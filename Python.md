...
- [Programiz](https://www.programiz.com/) Learn to code with these beginner-friendly tutorials and examples. Read tutorials, try examples, write programs, and learn to code. It also provides a platform to learn by solving coding challenges for free in [Programiz PRO Community Challenges] (https://app.programiz.pro/community-challenges)
...
- [Twisted Python Projects](https://www.manning.com/books/twisted-python-projects): A book that teaches the Python GUI skills.
